...
namespace APIVerve\Bingocardgenerator;
...
/**
 * Client for the Bingo Card Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/bingocardgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bingocardgenerator';
    ...
    private const VALIDATION_RULES = [
        'size' => ['type' => 'integer', 'required' => false, 'min' => 3, 'max' => 10],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BingocardgeneratorClient] {$message}\n";
        }
    }
}
