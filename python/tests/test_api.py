...
class TestBingocardgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = BingocardgeneratorAPIClient(self.api_key)

    @patch('apiverve_bingocardgenerator.apiClient.requests.get')
