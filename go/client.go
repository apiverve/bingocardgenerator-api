...
const (
	baseURL        = "https://api.apiverve.com/v1/bingocardgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Bingo Card Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Bingo Card Generator API client.
...
// Execute makes a request to the Bingo Card Generator API with typed parameters.
//
