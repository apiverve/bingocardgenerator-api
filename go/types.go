// Package bingocardgenerator provides a Go client for the Bingo Card Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/bingocardgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Bingo Card Generator API.
//
// Parameters:
//   - size: integer - Card size (3x3 to 10x10) [min: 3, max: 10]
//   - freeSpace: boolean - Include free space in center
type Request struct {
	Size int `json:"size,omitempty"` // Optional
	FreeSpace bool `json:"freeSpace,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"size": {Type: "integer", Required: false, Min: float64Ptr(3), Max: float64Ptr(10)},
		"freeSpace": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Bingo Card Generator API.
type ResponseData struct {
	...
	WinningPatterns []string `json:"winningPatterns"`
	Image ImageData `json:"image"`
}

// CardItem represents an item in the Card array.
