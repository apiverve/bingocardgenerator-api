...
namespace APIVerve.API.BingoCardGenerator
{
    ...
    /// <summary>
    /// Client for the BingoCardGenerator API
    /// </summary>
    public class BingoCardGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/bingocardgenerator";
        ...
        {
            { "size", new ValidationRule { Type = "integer", Required = false, Min = 3, Max = 10 } },
            { "freeSpace", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public BingoCardGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BingoCardGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BingoCardGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BingoCardGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BingoCardGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(BingoCardGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BingoCardGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BingoCardGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BingoCardGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BingoCardGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BingoCardGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BingoCardGeneratorQueryOptions options)
        {
