# Bingo Card Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:bingocardgenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.bingocardgenerator.BingoCardGeneratorAPIClient;
import com.apiverve.bingocardgenerator.APIResponse;
import com.apiverve.bingocardgenerator.APIException;

// Initialize the client
BingoCardGeneratorAPIClient client = new BingoCardGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("size", 5);
    parameters.put("freeSpace", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bingocardgenerator](https://docs.apiverve.com/ref/bingocardgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/bingocardgenerator](https://docs.apiverve.com/ref/bingocardgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bingocardgenerator-api/issues)
